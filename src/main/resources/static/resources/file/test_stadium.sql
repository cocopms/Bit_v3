...
SELECT * FROM users;
DROP TABLE users;
INSERT INTO users (userid,passwd,user_name,ssn,addr,profile_image,email,phone_number,register_date)
VALUES ('hong','1','홍길동','900101-1','서울','1','1','010-1234-1234','05-01');
DELETE FROM USER WHERE userid LIKE 'hong';

CREATE TABLE items (
item_id VARCHAR(10),
item_name VARCHAR(10),
take_date VARCHAR(10),
category VARCHAR(10),
take_place VARCHAR(10),
userid VARCHAR(10)
)
SELECT * FROM items;
INSERT INTO items (item_id, item_name, take_date, category, take_place, userid)
VALUES('0001','옷','5-8','옷','지하철','hong');
...
CONSTRAINT schedule_pk PRIMARY KEY (sche_date, stadium_id),
